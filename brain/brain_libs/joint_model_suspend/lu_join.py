        ...
        with tf.gfile.GFile(target_path, mode="r") as target_file:
            with tf.gfile.GFile(label_path, mode="r") as label_file:
                ...
                while source and target and label and (not max_size or counter < max_size):
                    ...
                    # TODO: Training join model may not need bucket
                    #target_ids.append(data_helper.EOS_ID)
...
def train():
    ...
    tag_vocab, rev_tag_vocab = data_helper.initialize_vocabulary(tag_vocab_path)
    label_vocab, rev_label_vocab = data_helper.initialize_vocabulary(label_vocab_path)
