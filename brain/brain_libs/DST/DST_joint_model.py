...
import re
sys.path.pop()
sys.path.append('../brain/brain_libs/LU_model')
import db
sys.path.pop()
sys.path.append('../brain/brain_libs/joint_model')
import get_lu_pred
sys.path.pop()
sys.path.append('../brain/brain_libs/data_resource')
...
#################################################################################################
    ...
    #DM = initialize()
        ...
        division = []
        doctor = []
        with open('../brain/brain_libs/data_resource/disease_dict.txt', 'r', encoding='utf-8') as r_disease:
            for line in r_disease:
                disease.append(line.replace('\n',''))
        with open('../brain/brain_libs/data_resource/week_dict.txt', 'r', encoding='utf-8') as r_week:
            for line in r_week:
                week.append(line.replace('\n',''))
        with open('../brain/brain_libs/data_resource/division_dict.txt', 'r', encoding='utf-8') as r_division:
