...
def train():
  ...
  if not os.path.exists(FLAGS.data_dir):
    ...
    print('Generating %s' % FLAGS.data_dir)
    os.makedirs(FLAGS.data_dir + '/train')
    print('Generating %s' % FLAGS.data_dir + '/train')
    os.makedirs(FLAGS.data_dir + '/valid')
    print('Generating %s' % FLAGS.data_dir + '/valid')
    os.makedirs(FLAGS.data_dir + '/test')
    print('Generating %s' % FLAGS.data_dir + '/test')
